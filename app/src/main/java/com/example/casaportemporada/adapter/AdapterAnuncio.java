...
public class AdapterAnuncio extends RecyclerView.Adapter<AdapterAnuncio.MyViewHolder> {
    ...
    public AdapterAnuncio(List<Anuncio> anuncioList, OnClick onClick) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Log.i("imagem", anuncio.getUrl_imagem());

        Picasso.get().load(anuncio.getUrl_imagem()).into(holder.img_anuncio);
